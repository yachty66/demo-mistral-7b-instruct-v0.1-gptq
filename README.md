...
# Banana.dev Mistral-7B-Instruct-v0.1-GPTQ starter template

This is a Mistral-7B-Instruct-v0.1-GPTQ starter template from [Banana.dev](https://www.banana.dev) that allows on-demand serverless GPU inference.
...
1. [Fork this](https://github.com/yachty66/demo-mistral-7b-instruct-v0.1-gptq/fork) repository to your own Github account.
